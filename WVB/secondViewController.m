...
- (void)viewDidLoad
{
    ...
    BookImage1_SouthAmerica  = [@[
                                ...
                                [UIImage imageNamed:@"パタゴニアを行く―世界でもっとも美しい大地.jpeg"],
    ...
    BookImage1_Africa  = [@[[UIImage imageNamed:@"サハラに死す.jpeg"],
...
//    self.book1Image.contentMode = UIViewContentModeCenter;//サイズを自動調整
    ...
    BookImage2_Asia  = [@[
                          ...
                          [UIImage imageNamed:@"僕たちは世界を変えることができない。But, we wanna build a school in Cambodia. .jpg"]
                        ]mutableCopy];
    ...
    BookImage2_Eourope  =[@[
                            [UIImage imageNamed:@"北アルプス テントを背中に山の旅へ .jpeg"],
    ...
    BookImage2_AroundTheWorld  = [@[
                                    [UIImage imageNamed:@"死ぬまでに行きたい! 世界の絶景.jpeg"],
