...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.textLabel.textColor = RGBA(139, 115, 85, 1.0);
...
//    [layer setBorderColor:[[UIColor whiteColor] CGColor]];
    ...
    //    cell.backgroundColor = RGBA(236, 242, 170, 0.5);//Beige
    [layer setBorderColor:[RGBA(139, 115, 85, 1.0) CGColor]];
...
forRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    // For odd
        ...
        cell.backgroundColor = RGBA(236, 242, 170, 0.2);//Wheat
    }
}
