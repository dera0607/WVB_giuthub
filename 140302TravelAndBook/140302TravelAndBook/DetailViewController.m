...
- (void)viewDidLoad
{
    ...
    self.PlaceLabel.text = appDelegate.Pass_NameData;
    self.PlaceLabel.textColor = RGBA(69, 44, 10, 1.0);
    ...
    self.PlaceImageView.image = appDelegate.Pass_NameImage;
    ...
    NSLog(@"セカンドビューAppDelegate_indexPath.row = %d", SelectedRow);
...
#pragma mark book1data
    ...
    BookImage1 = [@[BookImage1_Asia,
                    BookImage1_NorthAmerica,
                    BookImage1_SouthAmerica,
                    BookImage1_Eourope,
                    BookImage1_Africa,
                    BookImage1_Oceania,
